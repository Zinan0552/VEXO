      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            ...
            {/* Right Side - Availability and Filter Toggle */}
            <div className="flex items-center space-x-4">
              {/* Availability Filter */}
              <div className="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-2xl border border-gray-200">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-red-500 to-orange-500 text-white rounded-2xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                <SlidersHorizontal className="w-5 h-5" />
                <span>Filters</span>
                {getActiveFilterCount() > 0 && (
                  <span className="bg-white text-red-500 px-2 py-1 rounded-full text-xs font-bold min-w-6">
              ...
              {getActiveFilterCount() > 0 && (
                <button
                  ...
                  className="px-4 py-3 text-gray-600 hover:text-red-500 font-medium transition-colors duration-300"
                >
                  Clear All
                </button>
              )}
