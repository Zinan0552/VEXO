                ...
                <button
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-2xl border transition-all duration-300 ${
                    currentPage === 1
                      ...
                      : "bg-white text-gray-700 border-gray-300 hover:border-red-500 hover:text-red-600 hover:shadow-lg"
                  }`}
                >
                  ...
                  {getPageNumbers().map((number, index) => (
                    number === '...' ? (
                      ...
                      <button
                        ...
                        className={`w-10 h-10 rounded-2xl border transition-all duration-300 font-semibold ${
                          currentPage === number
                            ? "bg-gradient-to-r from-red-500 to-orange-500 text-white border-red-500 shadow-lg shadow-red-500/30"
